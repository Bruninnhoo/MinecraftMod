...
import com.bruno.brunomod.item.Cigarro;
...
public class ItemInit {
    ...
    public static final RegistryObject<Item> CIGARRO = register("cigarro",
            () -> new Cigarro(new Item.Properties().tab(BrunoMod.BRUNOMOD_TAB)));
